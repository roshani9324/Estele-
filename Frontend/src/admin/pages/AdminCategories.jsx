...
function CategoryImage({ category }) {
  ...
  return (
    <img
      ...
      className="h-14 w-14 shrink-0 rounded-xl object-cover bg-[#f5f2ee]"
      onError={(event) => {
      ...
      <div className="flex max-h-[92vh] w-full max-w-2xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div className="flex justify-end gap-3 border-t border-gray-100 bg-[#fcfbfa] px-6 py-4">
          ...
          <button
            ...
            form="category-form"
            disabled={saving}
            className="inline-flex min-w-[145px] items-center justify-center gap-2 rounded-xl bg-[#111] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
          >
            {saving ? (
              <>
                <Loader2
        ...
        <div className="px-5 py-6 md:px-8 md:py-8 lg:px-10">
          ...
          <div className="mb-7">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-gray-500">
              Organise your jewellery products
              into clear categories and manage
              their visibility from one place.
            </p>
          </div>
